...
ALTER TABLE public.peptide_entries
  DROP CONSTRAINT IF EXISTS peptide_entries_dose_unit_check;
...
ALTER TABLE public.peptide_entries
  DROP CONSTRAINT IF EXISTS peptide_entries_route_check;
...
ALTER TABLE public.peptide_entries
  DROP CONSTRAINT IF EXISTS peptide_entries_cycle_dates_check;
...
ALTER TABLE public.training_programs
  DROP CONSTRAINT IF EXISTS training_programs_total_weeks_check;
...
ALTER TABLE public.training_programs
  DROP CONSTRAINT IF EXISTS training_programs_sessions_check;
