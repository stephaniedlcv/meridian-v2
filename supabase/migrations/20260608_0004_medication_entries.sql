...
ALTER TABLE public.medication_entries
  DROP CONSTRAINT IF EXISTS medication_entries_category_check;
...
-- Dose unit values
ALTER TABLE public.medication_entries
  DROP CONSTRAINT IF EXISTS medication_entries_dose_unit_check;
...
-- Route values
ALTER TABLE public.medication_entries
  DROP CONSTRAINT IF EXISTS medication_entries_route_check;
...
ALTER TABLE public.medication_entries
  DROP CONSTRAINT IF EXISTS medication_entries_site_check;
